...
Address::PostCode::UserAgent - User agent for Address::PostCode::UK.
...
has 'ua'=> (is => 'rw', default => sub { HTTP::Tiny->new(agent => "Address-PostCode-UK/v1"); } );

=head1 DESCRIPTION

The L<Address::PostCode::UserAgent> module is part of the core library Address::PostCode::UK.
